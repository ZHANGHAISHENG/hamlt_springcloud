package com.hamlt.demo.redis.lock;


import com.hamlt.demo.common.constant.CommonConstant;
import com.hamlt.demo.common.exception.LockException;
import com.hamlt.demo.redis.lock.DistributedLock;
...
public class RedissonDistributedLock implements DistributedLock {
    ...
    @Autowired
    private RedissonClient redisson; // 有项目引入使用就不会报错
